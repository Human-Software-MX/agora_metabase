    ...
    (testing "can't change embedding-app-origins-interactive if :embedding feature is not available"
      (mt/with-premium-features #{}
        (is (thrown-with-msg?
             ...
             (embed.settings/embedding-app-origins-interactive! "https://www.metabase.com")))
        (testing "even if env is set, return the default value"
          (mt/with-temp-env-var-value! [mb-embedding-app-origins-interactive "https://www.metabase.com"]
